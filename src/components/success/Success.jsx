    ...
    <>
      ...
      <section className="bg-white text-black w-[90%] m-auto pt-[100px] pb-[100px]">
        ...
        <section className="flex justify-between">
          <div>
            <div className="w-[368px] h-[56px] bg-[#F3F5F7] rounded-[30px] flex mt-[50px]">
              <div className=" w-[195px] rounded-[30px] flex justify-center items-center text-[#90A3BF]">
                With SAM
              </div>
              <div className="bg-[#7C5CFC] w-[169px] ml-[20px] rounded-[30px] flex justify-center items-center text-[#FFFFFF]">
                Without SAM
              </div>
            </div>
            {/*  */}
